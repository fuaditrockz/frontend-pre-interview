...
export default class NotificationService {
  ...
  localNotif(soundName) {
    ...
    PushNotification.localNotification({
      ...
      bigText: 'Flight number bla bla bla will be fly today. Please track this flight to get more information about this.', // (optional) default: "message" prop
      subText: 'CX 880', // (optional) default: none
      ...
      title: 'Aviator', // (optional)
      message: 'Some saved flight give a notification for you.', // (required)
