...
export default class NotificationService {
  ...
  localNotif({
    ...
    PushNotification.localNotification({
      ...
      bigText: description || 'No description', // (optional) default: "message" prop
      ...
      id: id || this.lastId, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
      title: title || 'No title', // (optional)
      message: message || 'No message', // (required)
  ...
  scheduleNotif({
    ...
    PushNotification.localNotificationSchedule({
      date: forDate || new Date(Date.now() + 10 * 1000), // in 30 secs
  ...
  cancelNotif(id) {
    PushNotification.cancelLocalNotifications({id: id.toString() || this.lastId});
  }
